...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.min_worker_num'
        db.add_column(u'empress_application', 'min_worker_num',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Application.max_worker_num'
        db.add_column(u'empress_application', 'max_worker_num',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.min_worker_num'
        db.delete_column(u'empress_application', 'min_worker_num')

        # Deleting field 'Application.max_worker_num'
        db.delete_column(u'empress_application', 'max_worker_num')
    ...
    models = {
        ...
        u'empress.empressmission': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'1beea9ab-5988-4e86-a747-d888a99cd1f6'", 'max_length': '255', 'primary_key': 'True'}),
        ...
        u'empress.task': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'ex_data': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'id': ('django.db.models.fields.CharField', [], {'default': "'998308fe-c867-484f-b4ef-664ac1c538f1'", 'max_length': '255', 'primary_key': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'PENDING'", 'max_length': '255'})
        },
